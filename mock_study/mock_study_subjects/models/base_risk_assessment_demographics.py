...
class BaseRiskAssessmentDemographics(CrfModelMixin):
    ...
    marital_status_other = models.CharField(max_length=20, blank=True, null=True, verbose_name="If you selected 'Other', please enter your marital status.")

    race = models.CharField(max_length=10, choices=RACE)

    race_other = models.CharField(max_length=10, blank=True, null=True)
    ...
    education_other = models.CharField(max_length=50, blank=True, null=True, verbose_name="If you selected 'Other', please enter your level of education.")
